package com.prehistoriceclipse.prehistoric.server.world;

import com.prehistoriceclipse.prehistoric.server.init.PEBiomes;
import com.prehistoriceclipse.prehistoric.server.world.gen.layer.GenLayerPreclipse;
...
public class BiomeProviderPreclipse extends BiomeProvider {
    ...
    public BiomeProviderPreclipse()
    {
        ...
        biomesToSpawnIn.add(PEBiomes.ORIENT_VALLEY);
    }
