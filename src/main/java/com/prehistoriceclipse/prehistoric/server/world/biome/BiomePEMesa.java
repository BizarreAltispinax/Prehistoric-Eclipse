...
public class BiomePEMesa extends BiomePrehistoric {
    ...
    public BiomePEMesa()
    {
        super(new Biome.BiomeProperties("PEMesa").setTemperature(2.0F).setRainfall(0.0F).setRainDisabled());
    ...
    {
        return new BiomePEMesa.Decorator();
    }
