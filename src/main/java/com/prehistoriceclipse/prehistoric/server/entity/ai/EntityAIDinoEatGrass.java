...
public class EntityAIDinoEatGrass extends EntityAIAnimationBase
{
    //Copy of vanilla code to make it work with Animations
    ...
    public static String name = "DinoEatGrass";

    public EntityAIDinoEatGrass(EntityLiving grassEaterEntityIn)
    {
        super("DinoEatGrass");
    ...
    {
        if (this.grassEaterEntity.getRNG().nextInt(this.grassEaterEntity.isChild() ? 50 : 200) != 0)
        {
            return false;
        }
        else
