...
public class EntityMawsonia extends EntityAquatic {

    public EntityMawsonia(World worldIn) {
        super(worldIn);
    ...
    public ResourceLocation getDefaultTexture() {
        return new ResourceLocation(Reference.MOD_ID, "models/entity/maws/male.png");
    }

    @Override
    public EntityMawsonia createChild(EntityAgeable entity) {
        return new EntityMawsonia(this.world);
    }
