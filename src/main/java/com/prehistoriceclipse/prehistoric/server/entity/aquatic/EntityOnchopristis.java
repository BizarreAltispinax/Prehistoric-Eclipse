...
public class EntityOnchopristis extends EntityAquatic {

    public EntityOnchopristis(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks.addTask(0, new EntityAITargetWater(this, EntityLivingBase.class, true, new Predicate<Entity>() {
                    public boolean apply(@Nullable Entity p_apply_1_) {
                        return p_apply_1_ instanceof EntitySaurichthys;
                    }
                })
        );
    }
    ...
    public ResourceLocation getDefaultTexture() {
        return new ResourceLocation(Reference.MOD_ID, "models/entity/oncho/male.png");
    }

    @Override
    public EntityOnchopristis createChild(EntityAgeable entity) {
        return new EntityOnchopristis(this.world);
    }
