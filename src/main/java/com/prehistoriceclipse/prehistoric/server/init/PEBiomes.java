...
import com.prehistoriceclipse.prehistoric.server.world.biome.*;
...
public class PEBiomes {
    ...
    public static final Biome ORIENT_VALLEY = new BiomeOrientValley();
    ...
    public static void registerBiomes(final RegistryEvent.Register<Biome> event) {
        ...
        initBiome(event, ORIENT_VALLEY, "orient_valley", BiomeType.WARM, Type.PLAINS);
